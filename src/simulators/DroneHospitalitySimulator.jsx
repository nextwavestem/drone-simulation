...
import Hospitality from "../environments/Hospitality.jsx";

import BlockPad from "../components/blockly/BlockPad.jsx";
import "../css/droneHospitalitySimulator.css";

const DroneHospitalitySimulator = () => {
  ...
  return (
    <AppContainer>
      <div className="simulation-container">
        ...
        <div className="hospitality-canvas-container">
...
export default DroneHospitalitySimulator;
